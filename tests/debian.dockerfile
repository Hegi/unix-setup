...
RUN groupadd docker && useradd -s /bin/bash -m -U -u 1000 -G docker -p '$6$G3v.CB7SjMSP2IMP$giMSeGOun/txXObSkG3jK6vGUmiUBNIhA60sDg0ds/W2pldOFMgSYK5r2GgErvZxmzJhADrCdE.dc7s/OYDr6.' hegi \
